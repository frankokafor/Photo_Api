...
public interface UserRepository extends PagingAndSortingRepository<UserEntity, Long> {
	/*
	 * by extending the paging and sorting repository we now have an option of
	 * adding pageable in our return method where we can handle the amount of return
	 * values especially when calling a list.
	 * 
	 */
